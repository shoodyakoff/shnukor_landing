...
const DAILY_CARDS: SneakersCard[] = [
  {
    ...
    image: publicAsset("tinder-daily/daily-chunky.png"),
    bg: "#ff2a00",
    fg: "#fff",
    categoryId: 349,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-retro-low.png"),
    bg: "#facc15",
    fg: "#111",
    categoryId: 731,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-retro-basket.png"),
    bg: "#0044ff",
    fg: "#fff",
    categoryId: 730,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-trending.png"),
    bg: "#ccff00",
    fg: "#111",
    categoryId: 569,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-minimal.png"),
    bg: "#b0ddff",
    fg: "#111",
    categoryId: 576,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-puffy.png"),
    bg: "#7458ff",
    fg: "#fff",
    categoryId: 765,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-running.png"),
    bg: "#22c55e",
    fg: "#111",
    categoryId: 493,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-retro-runner.png"),
    bg: "#fb923c",
    fg: "#111",
    categoryId: 732,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-tech.png"),
    bg: "#111827",
    fg: "#fff",
    categoryId: 579,
    scenario: "daily",
  },
  {
    ...
    image: publicAsset("tinder-daily/daily-luxury.png"),
    bg: "#b45309",
    fg: "#fff",
    categoryId: 348,
    scenario: "daily",
...
const SPORT_CARD_IMAGE_OVERRIDES: Record<string, string> = {
  "basketball-rubber": publicAsset("tinder-sport/basketball-rubber.png"),
  "football-artificial": publicAsset("tinder-sport/football-artificial.png"),
  "football-base": publicAsset("tinder-sport/football-base.png"),
  "football-futsal": publicAsset("tinder-sport/football-futsal.png"),
  "football-natural": publicAsset("tinder-sport/football-natural.png"),
  "tennis-clay": publicAsset("tinder-sport/tennis-clay.png"),
  "run-track": publicAsset("tinder-sport/run-track.png"),
  "outdoor-hiking": publicAsset("tinder-sport/outdoor-hiking.png"),
};
