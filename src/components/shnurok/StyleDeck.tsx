...
export function StyleDeck({
  ...
  return (
    <div className="mx-auto grid h-full w-full max-w-[1400px] items-center gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(360px,500px)_minmax(0,1fr)] lg:gap-12 xl:gap-16">
