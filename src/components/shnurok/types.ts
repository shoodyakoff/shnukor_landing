...
export const SIZES = ["EU 36","EU 37","EU 38","EU 39","EU 40","EU 41","EU 42","EU 43","EU 44","EU 45","EU 46"];
...
export const COLORS = [
  ...
  { id: "neon",   name: "Яркий / акцентный", hex: "linear-gradient(135deg,#ccff00,#ff2a00,#0044ff)", text: "#111" },
