...
function HeroProductScene() {
  ...
  return (
    <div
      ...
      className="relative aspect-[16/9] w-full min-w-0 overflow-hidden rounded-[1.25rem] border border-cement bg-[radial-gradient(circle_at_18%_18%,#ffffff_0%,#f5fbff_28%,#e6f7ff_58%,#f7efe8_100%)] shadow-[0_18px_55px_rgba(10,10,10,0.10)] md:rounded-[1.5rem] xl:shadow-[0_24px_80px_rgba(10,10,10,0.10)]"
    >
      <style>{`
      ...
      <div
        data-hero-animated
        className="absolute left-4 top-[18%] grid w-[42%] gap-2 sm:left-7 sm:top-[19%] sm:gap-3"
        style={{ animation: "heroSelected 10s ease-in-out infinite" }}
      >
        <p
          data-hero-animated
          className="text-[0.58rem] font-semibold leading-tight tracking-[0.02em] text-suede sm:text-xs"
        ...
        {selected.map((item, index) => (
          <div
            key={item}
            className="rounded-full border border-white/80 bg-white/80 px-3 py-1.5 text-[0.62rem] font-bold text-outsole shadow-[0_8px_22px_rgba(10,10,10,0.08)] backdrop-blur sm:px-4 sm:py-2 sm:text-xs"
      ...
      <div className="absolute right-4 top-[18%] h-[58%] w-[43%] sm:right-8 sm:top-[19%]">
        <p
          data-hero-animated
        ...
        >
          <div className="relative flex h-[6.25rem] w-[6.25rem] items-center justify-center sm:h-[8.75rem] sm:w-[8.75rem]">
            <div
              data-hero-animated
      ...
      <div
        data-hero-animated
        className="absolute left-[38%] top-[42%] z-20 flex h-8 w-8 items-center justify-center rounded-full border border-[#ff7d73]/30 bg-white text-lg font-black leading-none text-[#d84337] shadow-[0_12px_28px_rgba(216,67,55,0.16)] sm:left-[48%] sm:top-[43%] sm:h-10 sm:w-10 sm:text-2xl"
      ...
      <div
        data-hero-animated
        className="absolute right-[8%] top-[42%] z-20 flex h-8 w-8 items-center justify-center rounded-full border border-[#45c782]/30 bg-white text-lg font-black leading-none text-[#17975b] shadow-[0_12px_28px_rgba(23,151,91,0.18)] sm:right-[13%] sm:top-[43%] sm:h-10 sm:w-10 sm:text-2xl"
      ...
      <div
        data-hero-animated
        className="absolute bottom-4 left-4 w-[47%] rounded-[1rem] border border-white/70 bg-white/75 p-2.5 shadow-[0_14px_34px_rgba(10,10,10,0.08)] backdrop-blur sm:bottom-8 sm:left-8 sm:w-[30%] sm:p-4"
      ...
      <div
        data-hero-animated
        className="absolute left-1/2 top-1/2 w-[82%] max-w-[34rem] sm:w-[88%]"
      ...
      >
        <div className="mx-auto flex w-full flex-col items-center">
          ...
          <div className="mt-2 grid w-full grid-cols-3 gap-2 sm:mt-5 sm:gap-3">
            {recommendations.map((item) => (
              <div
                key={item.name}
                className="min-w-0 rounded-[0.85rem] border border-white/80 bg-white p-1 shadow-[0_16px_38px_rgba(10,10,10,0.12)] sm:rounded-[1.15rem] sm:p-2"
              >
                <div className="aspect-[1.42/1] w-full overflow-hidden rounded-[0.7rem] bg-lace sm:aspect-[1.04/1] sm:rounded-[0.9rem]">
                  <img
                ...
                <p className="mt-1 min-h-[2em] px-0.5 text-center text-[0.47rem] font-bold leading-tight text-outsole sm:mt-2 sm:min-h-[2.2em] sm:text-xs">
                  {item.name}
                </p>
              </div>
            ))}
