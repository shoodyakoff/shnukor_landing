...
| Sport   | Фитнес / зал  | `fitness-base`          | Базовые для фитнеса              | обычная                                   |                                   5 | source refs only                                         |
| Sport   | Фитнес / зал  | `fitness-weightlifting` | Тяжёлая атлетика                 | с покрытием: помост / rubber gym floor    |                                   5 | source refs only                                         |
| Sport   | Фитнес / зал  | `fitness-functional`    | Функциональные тренировки        | с покрытием: rubber gym floor             |                                   5 | source refs only                                         |
| Sport   | Фитнес / зал  | `fitness-crossfit`      | Кроссфит                         | с покрытием: rubber gym floor / chalk     |                                   5 | source refs only                                         |
| Sport   | Фитнес / зал  | `fitness-group`         | Фитнес и групповые тренировки    | с покрытием: studio gym floor             |                                   5 | source refs only                                         |
